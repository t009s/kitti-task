const FeaturedCharity = (props) => {
    ...
    return (
        <div className='d-flex flex-column justify-content-between' style={{ height: '320px', marginRight: '20px' }}>
            <div className='d-flex flex-column'>
                ...
                <span className='fontManrope overflow-hidden' style={{ fontSize: '12px', color: '#a2a2a2', maxHeight: '110px' }}>{description}</span>
            </div>
